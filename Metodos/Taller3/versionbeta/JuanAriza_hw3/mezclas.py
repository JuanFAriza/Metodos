...
mat_cambio = np.matmul(cambioBase,mediciones_estandar) #Multiplico el cambio de base por las medidas
comp1 = mat_cambio[indicesPCA[0]] #Componente principal
comp2 = mat_cambio[indicesPCA[1]] #Componente secundario

fig = plt.figure()
ax = plt.axes()
ax.set_xlabel("Componente 1\n" + format(vectors.T[indicesPCA[0]]))
ax.set_ylabel("Componente 2\n" + format(vectors.T[indicesPCA[1]]))
